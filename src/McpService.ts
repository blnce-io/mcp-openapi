    ...
    server.tool(
      ...
      async () => {
        try {
          ...
          return {
            content: [{ type: 'text', text: stringify({ catalog }, { indent: 2 }) }],
          };
        } catch (error) {
    ...
    server.tool(
      ...
      async (args) => {
        try {
          ...
          return {
            content: [{ type: 'text', text: stringify({ operations }, { indent: 2 }) }],
          };
        } catch (error) {
    ...
    server.tool(
      ...
      async (args) => {
        try {
          ...
          return {
            content: [{ type: 'text', text: stringify({ schemas }, { indent: 2 }) }],
          };
        } catch (error) {
    ...
    server.tool(
      ...
      async (args) => {
        try {
          ...
          return {
            content: [{ type: 'text', text: stringify(operation, { indent: 2 }) }],
          };
        } catch (error) {
